...
describe('repay position test', () => {
  ...
  test('long position repay with base', async () => {
    const payload = await sdk.PositionModules.positionRepay({
      position_id: '0xeb178bcc6086f9b43535f8389bd1ab8a75a1acc0bf7695590e4ba10cae850c0a',
      is_quote: false,
      amount: d(0.1)
        .mul(10 ** 9)
        .toString(),
  ...
  test('long position repay with quote', async () => {
    const payload = await sdk.PositionModules.positionRepay({
  ...
  test('short position repay with quote', async () => {
    const payload = await sdk.PositionModules.positionRepay({
  ...
  test('short position repay with base', async () => {
    const payload = await sdk.PositionModules.positionRepay({
      position_id: '0xfe163e9b79229c284dbcba0450aa4f1de62098cffd5cd5a97c526ca89411268d',
      is_quote: false,
      amount: d(0.1)
